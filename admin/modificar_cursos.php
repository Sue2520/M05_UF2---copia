...
<body>
    ...
    if(!isset($_SESSION['rol'])) {
        ...
        if ($_POST){
            ...
            //Conectarte a la BD
            $sql = "UPDATE cursos SET  nom = '".$_POST['nombre']."', '".$_POST['descripcion']."', '".$_POST['horas']."', '".$_POST['fecha_inicio']."', '".$_POST['fecha_finalizacion']."', '".$_POST['dni_prof']."' WHERE idCurso = '".$_POST['IDcurso']."';";
